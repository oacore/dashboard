...
// const formatPercent = (number, precision = 2) =>
//   formatNumber(number * 100, { precision })
...
// const useLoading = (func, deps = []) =>
//   useMemo(() => {
//     const fetched = deps.reduce((done, value) => done && value != null, true)
