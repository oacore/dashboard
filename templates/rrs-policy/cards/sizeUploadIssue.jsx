...
const SizeUploadIssue = ({ handleClick, handleFileChange }) => (
  <div className={styles.uploadWrapper}>
    <div className={styles.titleWrapper}>
      <img src={issueSvg} alt="issueSvg" />
      <h3 className={styles.uploadTitle}>{text.upload.noSupport.sizeTitle}</h3>
    </div>
    <div className={styles.innerIssueWrapper}>
      <span className={styles.innerIssueTitle}>{text.upload.subInfo.size}</span>
      <input
        // ref={uploadRef}
        type="file"
        id="fileInput"
